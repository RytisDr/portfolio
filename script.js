...
function refresh() {
  if (
    (mobile.matches && inDesktopPage) ||
    (breakpoint.matches && inMobilePage)
  ) {
    location.reload();
  }
}
...
if (document.body.classList.contains("index")) {
  ...
  function GoToAbout() {
    ...
    document
      .querySelector(".worksTriangle h2")
      .classList.toggle("fontColorSwitch");
    if (mobile.matches) {
      document
        .querySelector(".aboutTriangle h2:nth-child(2)")
        .classList.toggle("dontDisplay");
      document
        .querySelector(".aboutTriangle h2")
        .classList.toggle("dontDisplay");
...
if (window.location.pathname.includes("works")) {
  ...
  function fetchWorks() {
    let endpoint =
      "https://rtsdr.com/kea/07/wp01/wp-json/wp/v2/portfolio_works?_embed&per_page=4&page=" +
      page;
    if (catid) {
      endpoint =
        "https://rtsdr.com/kea/07/wp01/wp-json/wp/v2/portfolio_works?_embed&per_page=4&page=" +
  ...
  fetch(
    "https://rtsdr.com/kea/07/wp01/wp-json/wp/v2/categories?_embed&parent=54"
  )
    .then(e => e.json())
    .then(buildMenu);
  ...
  function buildMenu(data) {
    ...
    data.forEach(item => {
      ...
      if (breakpoint.matches) {
        ...
        document
          .querySelector("#desktopFilterSec")
      ...
      function openMenu() {
        ...
        document
          .querySelector(".filterTriangle h2 span")
          .classList.toggle("fullOpacity");
...
if (window.location.pathname.includes("project")) {
  ...
  let endpoint =
    "https://rtsdr.com/kea/07/wp01/wp-json/wp/v2/portfolio_works/" + id;
